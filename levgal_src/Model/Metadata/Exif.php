...
class LevGal_Model_Metadata_Exif
{
	...
	{
		// We are going to be parsing this into ASCII with entities, which is the only way we can handle it in
		// all encodings ElkArte supports. We can assume the endianness is LE because this *should* be Windows XP+
		// only, which is LE only.
		$result = '';
